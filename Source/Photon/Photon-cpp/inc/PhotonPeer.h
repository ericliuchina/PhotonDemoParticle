...
namespace ExitGames
{
	namespace Photon
	{
		...
		public:
			...
			template<typename Ftype> bool connect(const Common::JString& ipAddr, const Common::JString& appID, Ftype customData);
			template<typename Ftype> bool connect(const Common::JString& ipAddr, const Common::JString& appID, Ftype pCustomDataArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize);
			template<typename Ftype> bool connect(const Common::JString& ipAddr, const Common::JString& appID, Ftype pCustomDataArray, const short* pArrSizes);
		...
		private:
			...
			bool usingWebSockets(nByte connectionProtocol);
			...
			bool PhotonPeer::connect(const Common::JString& ipAddr, const Common::JString& appID, Ftype customData)
			{
			...
			template<typename Ftype>
			bool PhotonPeer::connect(const Common::JString& ipAddr, const Common::JString& appID, Ftype pCustomDataArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize)
			{
			...
			template<typename Ftype>
			bool PhotonPeer::connect(const Common::JString& ipAddr, const Common::JString& appID, Ftype pCustomDataArray, const short* pArrSizes)
			{
