...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		public:
			...
			template<typename ktype, typename vtype> void addCustomProperty(const ktype& key, vtype pValueArray, typename Common::Helpers::ArrayLengthType<vtype>::type arrSize, const Common::Hashtable& expectedCustomProperties=Common::Hashtable(), const WebFlags& webflags=WebFlags());
			template<typename ktype, typename vtype> void addCustomProperty(const ktype& key, vtype pValueArray, const short* pArrSizes, const Common::Hashtable& expectedCustomProperties=Common::Hashtable(), const WebFlags& webflags=WebFlags());
		...
		private:
			...
			template<typename Etype> void setRoomProperty(nByte key, Etype pValueArray, typename Common::Helpers::ArrayLengthType<Etype>::type arrSize, const WebFlags& webflags);
			template<typename Etype> void setRoomProperty(nByte key, Etype pValueArray, const short* pArrSizes, const WebFlags& webflags);
		...
		template<typename ktype, typename vtype>
		void MutableRoom::addCustomProperty(const ktype& key, vtype pValueArray, typename Common::Helpers::ArrayLengthType<vtype>::type arrSize, const Common::Hashtable& expectedCustomProperties, const WebFlags& webflags)
		{
			Common::Hashtable hash;
		...
		template<typename ktype, typename vtype>
		void MutableRoom::addCustomProperty(const ktype& key, vtype pValueArray, const short* pArrSizes, const Common::Hashtable& expectedCustomProperties, const WebFlags& webflags)
		{
			Common::Hashtable hash;
