...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		bool Peer::opRaiseEvent(bool reliable, Ftype parameters, nByte eventCode, RaiseEventOptions options)
		{
		...
		template<typename Ftype>
		bool Peer::opRaiseEvent(bool reliable, Ftype pParameterArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize, nByte eventCode, RaiseEventOptions options)
		{
		...
		template<typename Ftype>
		bool Peer::opRaiseEvent(bool reliable, Ftype pParameterArray, const short* pArrSizes, nByte eventCode, RaiseEventOptions options)
		{
		...
		template<typename Ftype>
		bool Peer::opWebRpc(const Common::JString& uriPath, Ftype parameters, bool sendAuthCookie)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(!Common::Helpers::ConfirmAllowed<Ftype>::dimensions, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_SINGLE_VALUES);
		...
		template<typename Ftype>
		bool Peer::opWebRpc(const Common::JString& uriPath, Ftype pParameterArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize, bool sendAuthCookie)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(Common::Helpers::ConfirmAllowed<Ftype>::dimensions==1, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_1D_ARRAYS);
		...
		template<typename Ftype>
		bool Peer::opWebRpc(const Common::JString& uriPath, Ftype pParameterArray, const short* pArrSizes, bool sendAuthCookie)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG((Common::Helpers::ConfirmAllowed<Ftype>::dimensions>1), ERROR_THIS_OVERLOAD_IS_ONLY_FOR_MULTIDIMENSIONAL_ARRAYS);
